...
import org.workflow.scheduling.pool.WorkflowPool;
...
public class SimpleWorkflowSchedulingAlgorithmExample {
	   ////////////////////////// STATIC METHODS ///////////////////////
    /**
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            WorkflowDatacenter datacenter0 = WorkflowSchedulingUtil.createDatacenter("Datacenter_0");
             ...
             */
            List<CondorVM> vmlist0 = WorkflowSchedulingUtil.createVM(wfEngine.getSchedulerId(0), Parameters.getVmNum());
            ...
            //WorkflowSchedulingUtil.printWorkflowsFromJobs(outputList0);

            List<BaseClusterSimWorkflow> executedWorkflows =
            		(List<BaseClusterSimWorkflow>) WorkflowPool.INSTANCE.aggregateWorkflows(outputList0);
